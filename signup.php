...
<body>
    <div class="container">
        ...
        <div class="main">
            ...
            <input  id="tel"class="inn" type="tel" name="telephone" placeholder="Enter your telephone" required><br><br>
            <label for="pass">Password:</label><br>
            <input id="pass1" class="inp" type="password" name="password" placeholder="Enter your password" required><br><br>
            <label  class="labelp"for="pass">Confirm your password:</label><br>
            <input id="pass2" class="inp" type="password" placeholder="Re-enter your password" required><br>
            <button class="login" type="submit" onclick="myfunction()">Sign Up</button>
            </form>
        </div>
        <div class="footer">
...
if(isset($_POST['name'])){
    ...
    $sql="INSERT INTO `krish`.`login` (`name`, `number`, `password`) VALUES ('$name', '$number', '$password');";
   // echo $sql;
